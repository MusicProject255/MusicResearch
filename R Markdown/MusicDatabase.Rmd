...
cat <- lapply(wlist, getrest, y = 15)
dog <- t(wordvalue[, 3:3454])
right <- dog[,1]
#colnames(wholewordinfo) <<- c("genre1","genre2","genre3","mood1","mood2","tempo1","tempo2","temp3","artistype")
write.table(top5meta, "formattedtop5meta.csv")
write.table(wordvalue, "wordvalue.csv")
```
##View of data
